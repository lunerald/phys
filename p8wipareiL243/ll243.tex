...
\begin{enumerate}[1.]
	...
	{\bf \item Die einzelnen Widerstände haben folgende Werte:}\\
	...
	{\bf Die berechneten Widerstandswerte:}\\
	...
	\begin{enumerate}[a)]
		...
		\begin{minipage}{0.3\textwidth}
			...
			\begin{tabular}{|>{\columncolor[gray]{.8}}p{1cm}|p{0.8cm}|p{0.8cm}|p{0.8cm}|p{0.9cm}|}
				...
				\hline
				Gesamt &  $\SI{125}{\ohm}$& $\SI{5,0}{\volt}$& $\SI{40}{\milli\ampere}$&$\SI{0,2}{\watt}$  \\
				\hline
			\end{tabular}
		\end{minipage}
		\hspace{1cm}
		\begin{minipage}{0.3\textwidth}
			...
			\begin{tabular}{|>{\columncolor[gray]{.8}}p{1cm}|p{0.8cm}|p{0.8cm}|p{0.8cm}|p{0.9cm}|}
				...
				\hline
				Gesamt & $\SI{18}{\ohm}$ & $\SI{5,0}{\volt}$&  $\SI{0,28}{\ampere}$&$\SI{1,4}{\watt}$ \\
				\hline
			\end{tabular}
		\end{minipage}
		...
		\begin{minipage}{0.3\textwidth}
			...
			\begin{tabular}{|>{\columncolor[gray]{.8}}p{1cm}|p{0.8cm}|p{0.8cm}|p{0.8cm}|p{0.9cm}|}
				...
				\hline
				Gesamt &  $\SI{57}{\ohm}$& $\SI{5,0}{\volt}$&  $\SI{88}{\milli\ampere}$&$\SI{0,44}{\watt}$ \\
				\hline
			\end{tabular}
		\end{minipage}
		\hspace{1cm}
		\begin{minipage}{0.3\textwidth}
			...
			\begin{tabular}{|>{\columncolor[gray]{.8}}p{1cm}|p{0.8cm}|p{0.8cm}|p{0.8cm}|p{0.9cm}|}
				...
				\hline
				Gesamt &  $\SI{8,1}{\ohm}$& $\SI{5,0}{\volt}$&  $\SI{0,62}{\ampere}$&$\SI{3,1}{\watt}$ \\
				\hline
			\end{tabular}
		\end{minipage}
...
\begin{center}
	...
	Hier geht es zurück zum \href{https://www.okuyakl.de/phys/p8wipareiL243/aa243.pdf}{Aufgabenblatt}
\end{center}
